...
export const zhTW: Record<TranslationKey, string> = {
  ...
  "onboarding.action.openExisting": "從已有專案開啟",
  "onboarding.action.createNew": "建立新專案",
  ...
  "onboarding.dialog.newProjectLocation": "選擇新建專案的位置",
  "onboarding.dialog.sampleLocation": "選擇範例專案的儲存位置",
  "onboarding.defaultProjectName": "新建專案",
};
