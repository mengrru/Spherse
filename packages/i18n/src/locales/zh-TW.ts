...
export const zhTW: Record<TranslationKey, string> = {
  ...
  "agent-schedule.dialogTitle": "定時任務",
  ...
  "agent-schedule.targetSessionId": "工作階段 ID",
  "agent-schedule.targetSessionIdPlaceholder": "輸入要綁定的工作階段 ID",
  "agent-schedule.message": "訊息內容",
  "agent-schedule.messagePlaceholder": "輸入定時傳送的訊息內容...",
  "agent-schedule.notify": "完成後通知",
  "agent-schedule.notificationMessagePlaceholder": "通知內容，最多 30 字",
  "agent-schedule.notificationDefault": "定時任務已完成",
  ...
  "agent-schedule.logLimitNotice": "最多顯示 {count} 條，更多請查看 {path}",
  "agent-schedule.indicatorTooltip": "已開啟定時任務",
