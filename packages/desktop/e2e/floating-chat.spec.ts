...
function agentTrigger(page: Page) {
  return page.locator(`button[data-slot="context-menu-trigger"]:has-text("Assistant")`);
}

function agentPanel(page: Page) {
  return page.locator(`button[data-slot="context-menu-trigger"]:has-text("Assistant") >> xpath=ancestor::*[@data-slot="collapsible"]//*[@data-slot="collapsible-content"]`);
}
